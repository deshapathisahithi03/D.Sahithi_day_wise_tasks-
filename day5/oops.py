...
#the manager want to calculate salary of employee-the nouns are taken as classes
# field of employee-member variable+member function.
#employee-base class,hr,developer,analyst all are come under-child class
