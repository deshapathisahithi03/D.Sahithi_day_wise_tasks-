...
class Department:
    ...
    def promote(self, employee: Employee) -> None:
        employee.promote()  # Now correctly calls the method without passing an argument

    def increment_salary(self, employee: Employee) -> None:
        employee.increment_salary()  # Now correctly calls the method without passing an argument
